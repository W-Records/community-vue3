<template>
    ...
    <el-button type="primary" style="margin-left: 16px" @click="drawer2 = true;getSomeData()">
        更新文章
    </el-button>
    ...
    <el-drawer v-model="drawer2" :direction="direction">
        ...
        <template #footer>
            <div style="flex: auto">
                ...
                <el-button type="primary" @click="confirmClick">更新文章</el-button>
            </div>
        </template>
    </el-drawer>
</template>
...
// 导入请求
import { saveArticleService,updateArticleService } from "../api/ArticleApi.js"
...
async function confirmClick() {
    ...
    const returnData = await updateArticleService(article)
...
const getSomeData = function(){
    console.log("getSomeData事件触发");
    console.log("当前文章id为: "+props.articleId);
    coverUrlValue.value = props.coverUrl;
    textarea2.value = props.summary;
    MyRadio.value = props.categoryId;
}
